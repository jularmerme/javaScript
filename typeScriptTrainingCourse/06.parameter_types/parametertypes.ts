...
getProductDetails("Mobile");
console.log(getProductDetails(200));

// Declaring a function which accepts string datatype as parameter and returns string array
function getMobileByManufacturer0(manufacturer: string): string[] {
...
console.log(
  "The available mobile list: " + getMobileByManufacturer0("Samsung")
);
