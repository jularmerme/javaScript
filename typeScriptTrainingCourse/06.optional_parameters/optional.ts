...
function getProductDetails0(
  productName: string = "Clothing",
  productId: number
): string {
  return "Product: " + productName + " " + productId;
}

let productName: string = getProductDetails0(101);
console.log(productName);

let productName: string = getProductDetails0(undefined, 101);
console.log(productName);
